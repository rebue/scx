...
public class JwtSvcImpl implements JwtSvc {
    ...
    public Ro<JwtSignRa> sign(final JwtSignTo to) {
        try {
            ...
            final Date          expirationTime   = LocalDateUtils.localDateTime2Date(
                    nowLocalDateTime.plusSeconds(jwtProperties.getExpirationDuration().getSeconds()));
            ...
            return new Ro<>(ResultDic.SUCCESS, "JWT签名成功: userId-" + to.getUserId() + "; sign-" + sign, null,
                    new JwtSignRa(sign, expirationTime));
