...
public class SgnSecretCtrl {
    ...
    public Mono<Ro<IdRa<java.lang.String>>> add(@RequestBody final SgnSecretAddTo to) {
    ...
    public Mono<Ro<PojoRa<SgnSecretMo>>> getById(@RequestParam("id") final java.lang.String id) {
