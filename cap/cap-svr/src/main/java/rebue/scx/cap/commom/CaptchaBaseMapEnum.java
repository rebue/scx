...
public enum CaptchaBaseMapEnum {
    ...
    CaptchaBaseMapEnum(final String  codeValue, final String codeDesc) {
    ...
    //根据codeValue获取枚举
    public static CaptchaBaseMapEnum parseFromCodeValue(final String codeValue){
        for (final CaptchaBaseMapEnum e : CaptchaBaseMapEnum.values()){
    ...
    public static String getCodeDescByCodeBalue(final String codeValue){
        final CaptchaBaseMapEnum enumItem = parseFromCodeValue(codeValue);
