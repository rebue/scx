...
public enum RepCodeEnum {
    ...
    RepCodeEnum(final String code, final String desc) {
        this.code = code;
        this.desc = desc;
    }
     ...
     * @return
     */
    public ResponseModel parseError(final Object... fieldNames) {
        final ResponseModel errorMessage=new ResponseModel();
        final String newDesc = MessageFormat.format(desc, fieldNames);

        errorMessage.setRepCode(code);
