...
public class AjCaptchaProperties {
    ...
    public void setClickWordCount(final int clickWordCount) {
    ...
    public void setHistoryDataClearEnable(final boolean historyDataClearEnable) {
    ...
    public void setReqFrequencyLimitEnable(final boolean reqFrequencyLimitEnable) {
    ...
    public void setReqGetLockLimit(final int reqGetLockLimit) {
    ...
    public void setReqGetLockSeconds(final int reqGetLockSeconds) {
    ...
    public void setReqGetMinuteLimit(final int reqGetMinuteLimit) {
    ...
    public void setReqCheckMinuteLimit(final int reqCheckMinuteLimit) {
    ...
    public void setReqVerifyMinuteLimit(final int reqVerifyMinuteLimit) {
    ...
    public void setType(final CaptchaTypeEnum type) {
        this.type = type;
    }
    ...
    public void setPicClick(final String picClick) {
    ...
    public void setWaterFont(final String waterFont) {
    ...
    public void setSlipOffset(final String slipOffset) {
    ...
    public void setAesStatus(final Boolean aesStatus) {
    ...
    public void setCacheType(final StorageType cacheType) {
    ...
    public void setInterferenceOptions(final String interferenceOptions) {
    ...
    public void setCacheNumber(final String cacheNumber) {
    ...
    public void setTimingClear(final String timingClear) {
