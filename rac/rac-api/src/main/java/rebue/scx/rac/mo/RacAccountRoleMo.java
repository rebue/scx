...
public class RacAccountRoleMo implements Serializable, Mo<Long> {
     ...
     */
    @NotNull(groups = ModifyGroup.class, message = "账户角色ID不能为空")
    @PositiveOrZero(message = "账户角色ID不能为负数")
    private Long              id;
    ...
    public boolean equals(Object that) {
        ...
        RacAccountRoleMo other = (RacAccountRoleMo) that;
