...
public class RacDomainMo implements Serializable, Mo<String> {
     ...
     */
    @NotBlank(groups = ModifyGroup.class, message = "领域ID不能为空") @Length(max = 32, message = "领域ID的长度不能大于32")
    private String id;
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @NotBlank(groups = AddGroup.class, message = "领域名称不能为空") @Length(max = 20, message = "领域名称的长度不能大于20")
    private String name;
