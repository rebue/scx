...
public class RacRoleMo implements Serializable, Mo<Long> {
     ...
     */
    @NotNull(groups = ModifyGroup.class, message = "角色ID不能为空") @PositiveOrZero(message = "角色ID不能为负数")
    private Long id;
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @NotBlank(groups = AddGroup.class, message = "角色名称不能为空") @Length(max = 20, message = "角色名称的长度不能大于20")
    private String name;
