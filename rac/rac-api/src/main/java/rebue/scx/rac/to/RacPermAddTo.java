...
public class RacPermAddTo implements Serializable {
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @NotNull(message = "权限分组ID不能为空") @PositiveOrZero(message = "权限分组ID不能为负数")
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @NotBlank(message = "权限名称不能为空") @Length(max = 20, message = "权限名称的长度不能大于20")
    private String name;
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @NotNull(message = "顺序号不能为空") @PositiveOrZero(message = "顺序号不能为负数")
