...
public class RacPermUrnMo implements Serializable, Mo<Long> {
     ...
     */
    @NotNull(groups = ModifyGroup.class, message = "权限URN的ID不能为空") @PositiveOrZero(message = "权限URN的ID不能为负数")
    private Long id;
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @NotBlank(groups = AddGroup.class, message = "URN不能为空") @Length(max = 100, message = "URN的长度不能大于100")
    private String urn;
