...
-- 平台管理员
INSERT INTO RAC_ACCOUNT (ID,DOMAIN_ID,SIGN_IN_NAME,SIGN_IN_PSWD,SIGN_IN_PSWD_SALT, SIGN_IN_NICKNAME,CREATE_TIMESTAMP,UPDATE_TIMESTAMP)VALUES(1,'platform','super','05eeac84965236b8a479c3ebef3a2dc4','dX3jbg','平台管理员',UNIX_TIMESTAMP(SYSDATE()) * 1000,UNIX_TIMESTAMP(SYSDATE()) * 1000);
-- 运营管理员
