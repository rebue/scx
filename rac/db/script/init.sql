...
-- 平台管理员
INSERT INTO RAC_ACCOUNT (ID, SIGN_IN_NAME,SIGN_IN_PSWD,SIGN_IN_PSWD_SALT, SIGN_IN_NICKNAME,CREATE_TIMESTAMP,UPDATE_TIMESTAMP)VALUES(1,'admin','28bac2dc3862a24b376314014d8ef920','zcSeWA','平台管理员',UNIX_TIMESTAMP(SYSDATE()) * 1000,UNIX_TIMESTAMP(SYSDATE()) * 1000);
