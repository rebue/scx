...
public class RacAccountSvcTests {
	 ...
	 */
	@Test
	public void testPageUserAccount() {
		final RacAccountPageTo to = new RacAccountPageTo();
		to.setPageNum(1);
		to.setPageSize(10);
		final PageInfo<UserAccountMo> pageUserAccount = _svc.pageUserAccount(to);

		log.info("查询用户账户的返回值为：" + pageUserAccount);
	}
}
