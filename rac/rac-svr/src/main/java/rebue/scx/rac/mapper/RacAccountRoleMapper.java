...
import static rebue.scx.rac.mapper.RacAccountRoleDynamicSqlSupport.*;
...
public interface RacAccountRoleMapper extends MapperRootInterface<RacAccountRoleMo, Long> {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="RacAccountRoleMoResult", value = {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insert(RacAccountRoleMo record) {
        return MyBatis3Utils.insert(this::insert, record, racAccountRole, c ->
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insertMultiple(Collection<RacAccountRoleMo> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, racAccountRole, c ->
            c.map(id).toProperty("id")
            .map(roleId).toProperty("roleId")
            .map(accountId).toProperty("accountId")
        );
