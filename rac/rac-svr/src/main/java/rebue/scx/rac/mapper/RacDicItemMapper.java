...
public interface RacDicItemMapper extends MapperRootInterface<RacDicItemMo, String> {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
     */
    BasicColumn[] selectList = BasicColumn.columnList(id, dicId, name, remark);
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="RacDicItemMoResult", value = {
        @Result(column="ID", property="id", jdbcType=JdbcType.VARCHAR, id=true),
        @Result(column="DIC_ID", property="dicId", jdbcType=JdbcType.VARCHAR),
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insert(RacDicItemMo record) {
        return MyBatis3Utils.insert(this::insert, record, racDicItem, c ->
            c.map(id).toProperty("id")
            .map(dicId).toProperty("dicId")
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insertMultiple(Collection<RacDicItemMo> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, racDicItem, c ->
            c.map(id).toProperty("id")
            .map(dicId).toProperty("dicId")
            .map(name).toProperty("name")
            .map(remark).toProperty("remark")
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insertSelective(RacDicItemMo record) {
        return MyBatis3Utils.insert(this::insert, record, racDicItem, c ->
            ...
            .map(dicId).toPropertyWhenPresent("dicId", record::getDicId)
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(RacDicItemMo record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalTo(record::getId)
                .set(dicId).equalTo(record::getDicId)
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(RacDicItemMo record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalToWhenPresent(record::getId)
                .set(dicId).equalToWhenPresent(record::getDicId)
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int updateByPrimaryKey(RacDicItemMo record) {
        return update(c ->
            c.set(dicId).equalTo(record::getDicId)
            .set(name).equalTo(record::getName)
            .set(remark).equalTo(record::getRemark)
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int updateByPrimaryKeySelective(RacDicItemMo record) {
        return update(c ->
            c.set(dicId).equalToWhenPresent(record::getDicId)
            .set(name).equalToWhenPresent(record::getName)
            .set(remark).equalToWhenPresent(record::getRemark)
            .where(id, isEqualTo(record::getId))
        );
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int deleteSelective(RacDicItemMo record) {
        return delete(c ->
            ...
            .and(dicId, isEqualToWhenPresent(record::getDicId))
