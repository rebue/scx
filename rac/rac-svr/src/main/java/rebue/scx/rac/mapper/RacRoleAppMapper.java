...
public interface RacRoleAppMapper extends MapperRootInterface<RacRoleAppMo, Long> {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="RacRoleAppMoResult", value = {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insert(RacRoleAppMo record) {
        return MyBatis3Utils.insert(this::insert, record, racRoleApp, c ->
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insertMultiple(Collection<RacRoleAppMo> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, racRoleApp, c ->
            c.map(id).toProperty("id")
            .map(appId).toProperty("appId")
            .map(roleId).toProperty("roleId")
        );
