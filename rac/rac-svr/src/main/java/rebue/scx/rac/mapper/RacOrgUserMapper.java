...
import static rebue.scx.rac.mapper.RacOrgUserDynamicSqlSupport.id;
import static rebue.scx.rac.mapper.RacOrgUserDynamicSqlSupport.orgId;
import static rebue.scx.rac.mapper.RacOrgUserDynamicSqlSupport.racOrgUser;
import static rebue.scx.rac.mapper.RacOrgUserDynamicSqlSupport.userId;
...
public interface RacOrgUserMapper extends MapperRootInterface<RacOrgUserMo, Long> {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
     */
    default int deleteSelective(RacOrgUserMo record) {
        return delete(c ->
