...
import static rebue.scx.rac.mapper.RacDomainDynamicSqlSupport.*;
...
public interface RacDomainMapper extends MapperRootInterface<RacDomainMo, String> {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="RacDomainMoResult", value = {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insert(RacDomainMo record) {
        return MyBatis3Utils.insert(this::insert, record, racDomain, c ->
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insertMultiple(Collection<RacDomainMo> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, racDomain, c ->
            c.map(id).toProperty("id")
            .map(name).toProperty("name")
            .map(remark).toProperty("remark")
        );
