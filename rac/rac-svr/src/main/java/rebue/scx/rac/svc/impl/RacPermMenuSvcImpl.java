...
@Slf4j
@Service
public class RacPermMenuSvcImpl extends BaseSvcImpl<java.lang.Long, RacPermMenuJo, RacPermMenuDao, RacPermMenuMo, RacPermMenuMapper> implements RacPermMenuSvc {
    ...
    public Ro add(final RacPermMenuMo mo) {
        log.info("RacPermMenuSvc.add: 添加权限菜单 mo-{}", mo);
        // 如果id为空那么自动生成分布式id
