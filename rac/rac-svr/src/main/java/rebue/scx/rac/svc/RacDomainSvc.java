 ...
 */
@Validated
public interface RacDomainSvc extends BaseSvc<java.lang.String, RacDomainAddTo, RacDomainModifyTo, RacDomainDelTo, RacDomainOneTo, RacDomainListTo, RacDomainMo, RacDomainJo> {
}
