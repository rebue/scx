 ...
 */
@Validated
public interface RacPersonSvc extends BaseSvc<java.lang.Long, RacPersonAddTo, RacPersonModifyTo, RacPersonDelTo, RacPersonOneTo, RacPersonPageTo, RacPersonMo, RacPersonJo> {
}
