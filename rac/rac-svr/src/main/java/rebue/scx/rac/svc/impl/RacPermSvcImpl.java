...
@Service
public class RacPermSvcImpl extends
    BaseSvcImpl<java.lang.Long, RacPermAddTo, RacPermModifyTo, RacPermDelTo, RacPermOneTo, RacPermPageTo, RacPermMo, RacPermJo, RacPermMapper, RacPermDao> implements RacPermSvc {
