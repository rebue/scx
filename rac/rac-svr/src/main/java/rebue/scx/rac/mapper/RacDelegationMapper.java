...
public interface RacDelegationMapper extends MapperRootInterface<RacDelegationMo, Long> {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="RacDelegationMoResult", value = {
        @Result(column="ID", property="id", jdbcType=JdbcType.BIGINT, id=true),
        @Result(column="PRINCIPAL_ID", property="principalId", jdbcType=JdbcType.BIGINT),
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insert(RacDelegationMo record) {
        return MyBatis3Utils.insert(this::insert, record, racDelegation, c ->
            c.map(id).toProperty("id")
            .map(principalId).toProperty("principalId")
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insertMultiple(Collection<RacDelegationMo> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, racDelegation, c ->
            c.map(id).toProperty("id")
            .map(principalId).toProperty("principalId")
            .map(agentId).toProperty("agentId")
        );
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insertSelective(RacDelegationMo record) {
        return MyBatis3Utils.insert(this::insert, record, racDelegation, c ->
            ...
            .map(principalId).toPropertyWhenPresent("principalId", record::getPrincipalId)
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(RacDelegationMo record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalTo(record::getId)
                .set(principalId).equalTo(record::getPrincipalId)
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(RacDelegationMo record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalToWhenPresent(record::getId)
                .set(principalId).equalToWhenPresent(record::getPrincipalId)
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int updateByPrimaryKey(RacDelegationMo record) {
        return update(c ->
            c.set(principalId).equalTo(record::getPrincipalId)
            .set(agentId).equalTo(record::getAgentId)
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int updateByPrimaryKeySelective(RacDelegationMo record) {
        return update(c ->
            c.set(principalId).equalToWhenPresent(record::getPrincipalId)
            .set(agentId).equalToWhenPresent(record::getAgentId)
            .where(id, isEqualTo(record::getId))
        );
    }
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int deleteSelective(RacDelegationMo record) {
        return delete(c ->
            ...
            .and(principalId, isEqualToWhenPresent(record::getPrincipalId))
            .and(agentId, isEqualToWhenPresent(record::getAgentId))
        );
    }
