...
@Validated
public interface RacPermGroupSvc extends BaseSvc<java.lang.String, RacPermGroupAddTo, RacPermGroupModifyTo, RacPermGroupQueryTo, RacPermGroupMo, RacPermGroupJo> {
}
