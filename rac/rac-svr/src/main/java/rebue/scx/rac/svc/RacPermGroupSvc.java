...
@Validated
public interface RacPermGroupSvc extends BaseSvc<java.lang.String, RacPermGroupAddTo, RacPermGroupModifyTo, RacPermGroupDelTo, RacPermGroupOneTo, RacPermGroupListTo, RacPermGroupMo, RacPermGroupJo> {
}
