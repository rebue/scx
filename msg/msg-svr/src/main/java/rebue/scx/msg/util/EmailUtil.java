...
// }
//
// public static String sendTemplet(final String urlParam, final String dates[], final String var) throws Throwable {
// // 创建httpClient实例对象
// final HttpClient httpClient = new HttpClient();
// // 设置httpClient连接主机服务器超时时间：15000毫秒
// httpClient.getHttpConnectionManager().getParams().setConnectionTimeout(15000);
...
// }
// }
>>>>>>> branch '1.2.4' of git@github.com:rebue/scx.git
