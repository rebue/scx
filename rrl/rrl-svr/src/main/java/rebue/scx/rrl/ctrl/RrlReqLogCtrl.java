...
public class RrlReqLogCtrl {
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @PostMapping("/rrl/req-log")
    public Mono<Ro<IdRa<java.lang.Long>>> add(@RequestBody final RrlReqLogAddTo to) {
     ...
     * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @PutMapping("/rrl/req-log")
    public Mono<Ro<?>> modify(@RequestBody final RrlReqLogModifyTo to) {
