...
public interface OapAppMapper extends MapperRootInterface<OapAppMo, Long> {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="OapAppMoResult", value = {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insert(OapAppMo record) {
        return MyBatis3Utils.insert(this::insert, record, oapApp, c ->
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insertMultiple(Collection<OapAppMo> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, oapApp, c ->
            c.map(id).toProperty("id")
            .map(appId).toProperty("appId")
            .map(clientId).toProperty("clientId")
            .map(secret).toProperty("secret")
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int deleteSelective(OapAppMo record) {
        return delete(c ->
            ...
            .and(clientId, isEqualToWhenPresent(record::getClientId))
