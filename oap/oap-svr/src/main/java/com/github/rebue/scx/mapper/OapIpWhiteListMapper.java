...
public interface OapIpWhiteListMapper extends MapperRootInterface<OapIpWhiteListMo, Long> {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
     */
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="OapIpWhiteListMoResult", value = {
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insert(OapIpWhiteListMo record) {
        return MyBatis3Utils.insert(this::insert, record, oapIpWhiteList, c ->
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int insertMultiple(Collection<OapIpWhiteListMo> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, oapIpWhiteList, c ->
            c.map(id).toProperty("id")
            .map(appId).toProperty("appId")
            .map(ipAddr).toProperty("ipAddr")
            .map(createTimestamp).toProperty("createTimestamp")
    ...
    * @mbg.generated 自动生成，如需修改，请删除本行
    ...
    default int deleteSelective(OapIpWhiteListMo record) {
        return delete(c ->
            ...
            .and(ipAddr, isEqualToWhenPresent(record::getIpAddr))
